...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "assets/astronaut.svg", "size": 5813, "type": "image/svg+xml" }, { "file": "assets/background-stars.svg", "size": 6377, "type": "image/svg+xml" }, { "file": "assets/favicon-32x32.png", "size": 1063, "type": "image/png" }, { "file": "assets/geology-earth.png", "size": 34863, "type": "image/png" }, { "file": "assets/geology-jupiter.png", "size": 26685, "type": "image/png" }, { "file": "assets/geology-mars.png", "size": 43807, "type": "image/png" }, { "file": "assets/geology-mercury.png", "size": 49709, "type": "image/png" }, { "file": "assets/geology-neptune.png", "size": 31630, "type": "image/png" }, { "file": "assets/geology-saturn.png", "size": 30730, "type": "image/png" }, { "file": "assets/geology-uranus.png", "size": 24391, "type": "image/png" }, { "file": "assets/geology-venus.png", "size": 44183, "type": "image/png" }, { "file": "assets/icon-chevron.svg", "size": 130, "type": "image/svg+xml" }, { "file": "assets/icon-hamburger.svg", "size": 157, "type": "image/svg+xml" }, { "file": "assets/icon-source.svg", "size": 629, "type": "image/svg+xml" }, { "file": "assets/planet-earth-internal.svg", "size": 6624, "type": "image/svg+xml" }, { "file": "assets/planet-earth.svg", "size": 6169, "type": "image/svg+xml" }, { "file": "assets/planet-jupiter-internal.svg", "size": 6705, "type": "image/svg+xml" }, { "file": "assets/planet-jupiter.svg", "size": 5877, "type": "image/svg+xml" }, { "file": "assets/planet-mars-internal.svg", "size": 2905, "type": "image/svg+xml" }, { "file": "assets/planet-mars.svg", "size": 2460, "type": "image/svg+xml" }, { "file": "assets/planet-mercury-internal.svg", "size": 2085, "type": "image/svg+xml" }, { "file": "assets/planet-mercury.svg", "size": 1697, "type": "image/svg+xml" }, { "file": "assets/planet-neptune-internal.svg", "size": 4995, "type": "image/svg+xml" }, { "file": "assets/planet-neptune.svg", "size": 4575, "type": "image/svg+xml" }, { "file": "assets/planet-saturn-internal.svg", "size": 4335, "type": "image/svg+xml" }, { "file": "assets/planet-saturn.svg", "size": 3838, "type": "image/svg+xml" }, { "file": "assets/planet-uranus-internal.svg", "size": 5042, "type": "image/svg+xml" }, { "file": "assets/planet-uranus.svg", "size": 4582, "type": "image/svg+xml" }, { "file": "assets/planet-venus-internal.svg", "size": 3779, "type": "image/svg+xml" }, { "file": "assets/planet-venus.svg", "size": 3456, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }],
  ...
  routes: [
    ...
    },
    {
      type: "page",
      pattern: /^\/([^/]+?)\/?$/,
      params: (m) => ({ planet: d(m[1]) }),
      a: ["src/routes/__layout.svelte", "src/routes/[planet].svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    }
  ]
};
...
var module_lookup = {
  ...
  "src/routes/[planet].svelte": () => Promise.resolve().then(function() {
    return _planet_;
  })
};
...
var PLANETDATA = [
  ...
  },
  {
    ...
    geology: {
      content: "The best known feature of Jupiter is the Great Red Spot, a persistent anticyclonic storm located 22\xB0 south of the equator. It is known to have existed since at least 1831, and possibly since 1665.",
      source: "https://en.wikipedia.org/wiki/Jupiter#Great_Red_Spot_and_other_vortices"
    },
    rotation: "9.93 Hours",
    revolution: "11.86 Years",
    radius: "69,911 KM",
    temperature: "-108\xB0c",
    images: {
  ...
  },
  {
    ...
    geology: {
      content: "The composition of Uranus's atmosphere is different from its bulk, consisting mainly of molecular hydrogen and helium. The helium molar fraction, i.e. the number of helium atoms per molecule of gas, is 0.15\xB10.03 in the upper troposphere.",
      source: "https://en.wikipedia.org/wiki/Uranus#Atmosphere"
    },
    rotation: "17.2 Hours",
    revolution: "84 Years",
    radius: "25,362 KM",
    temperature: "-195\xB0c",
    images: {
...
var isDrawerOpen = writable2(false);
var Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $isDrawerOpen, $$unsubscribe_isDrawerOpen;
  ...
  return `<nav class="${"\r\n        relative\r\n        grid\r\n        grid-flow-col\r\n        md:grid-flow-row \r\n        lg:grid-flow-col \r\n        w-screen\r\n        h-[85px]\r\n        md:h-[159px] \r\n        lg:h-[85px] \r\n        border-b-[1px]\r\n        border-grey-600 \r\n        overflow-hidden\r\n        text-white\r\n        z-[2]\r\n    "}"><a href="${"/"}" class="${"justify-self-start self-center md:place-self-center lg:justify-self-start transform translate-x-8 md:translate-x-0 lg:translate-x-8"}"><h1 class="${"font-ant text-[28px] tracking-[-1.05px] leading-[25px] uppercase"}">The Planets</h1></a>
    <ul class="${"grid grid-flow-col place-self-center w-min h-full gap-8 justify-self-end md:justify-self-center lg:justify-self-end md:mr-0 lg:mr-10"}">${each(planets, (planet) => `<li${add_attribute("class", `hidden md:grid h-full place-content-center transition-all hover:border-t-4 border-${COLORS[planet.toLowerCase()]}`, 0)}><a${add_attribute("href", `/${planet}`, 0)} class="${"uppercase font-spart font-bold hover:opacity-100 opacity-75 text-xs leading-[25px] transition-opacity"}">${escape2(planet)}</a>
        ...
        <li class="${[
    "grid md:hidden w-max self-center justify-self-end mr-10 cursor-pointer",
    $isDrawerOpen ? "opacity-50" : ""
  ].join(" ").trim()}"><img src="${"/assets/icon-hamburger.svg"}" alt="${"drawer button"}"></li></ul></nav>`;
});
var NavigationDrawer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_isDrawerOpen;
...
var css = {
  code: "@import url('https://fonts.googleapis.com/css2?family=Antonio:wght@500&family=Spartan:wght@400;700&display=swap');@tailwind base;@tailwind components;@tailwind utilities;",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\r\\n    import { fade } from 'svelte/transition'\\r\\n    import Navigation from '$lib/Navigation.svelte'\\r\\n    import NavigationDrawer from '$lib/NavigationDrawer.svelte'\\r\\n    import { isDrawerOpen } from '$lib/stores.js'\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"\\r\\n        absolute\\r\\n        top-0\\r\\n        left-0 \\r\\n        overflow-hidden \\r\\n        overflow-y-scroll\\r\\n        w-screen \\r\\n        h-screen\\r\\n        bg-blue-900\\r\\n    \\"\\r\\n    style=\\"background-image: url('/assets/background-stars.svg');\\"\\r\\n>\\r\\n\\r\\n    <Navigation/>\\r\\n    {#if $isDrawerOpen}\\r\\n        <NavigationDrawer/>\\r\\n    {:else}\\r\\n        <div in:fade={{delay: 250}} class=\\"grid w-full h-full\\">\\r\\n            <slot></slot>\\r\\n        </div>\\r\\n    {/if}\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n    @import url('https://fonts.googleapis.com/css2?family=Antonio:wght@500&family=Spartan:wght@400;700&display=swap');\\r\\n\\r\\n    @tailwind base;\\r\\n    @tailwind components;\\r\\n    @tailwind utilities;\\r\\n</style>"],"names":[],"mappings":"AA+BI,QAAQ,IAAI,oGAAoG,CAAC,CAAC,AAElH,UAAU,IAAI,CAAC,AACf,UAAU,UAAU,CAAC,AACrB,UAAU,SAAS,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_isDrawerOpen();
  return `<div class="${"\r\n        absolute\r\n        top-0\r\n        left-0 \r\n        overflow-hidden \r\n        overflow-y-scroll\r\n        w-screen \r\n        h-screen\r\n        bg-blue-900\r\n    "}" style="${"background-image: url('/assets/background-stars.svg');"}">${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})}
    ${$isDrawerOpen ? `${validate_component(NavigationDrawer, "NavigationDrawer").$$render($$result, {}, {}, {})}` : `<div class="${"grid w-full h-full"}">${slots.default ? slots.default({}) : ``}</div>`}
</div>`;
});
...
var _404 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>THE PLANETS | 404</title>`, ""}`, ""}

<main class="${"relative grid w-full h-full text-white"}"><h1 class="${"\r\n        font-ant\r\n        tracking-tighter \r\n        text-[4rem] md:text-[6rem] \r\n        text-center \r\n        place-self-center \r\n        transform \r\n        translate-x-2 \r\n        rotate-[-25deg] \r\n        translate-y-5 md:translate-y-0\r\n    "}">404</h1>
    <img src="${"/assets/astronaut.svg"}" class="${"\r\n        absolute \r\n        top-[53%] \r\n        left-1/2 \r\n        w-[750px] \r\n        h-[750px] \r\n        transform \r\n        -translate-y-1/2 \r\n        -translate-x-1/2 \r\n        animate-pulse\r\n    "}" alt="${""}"></main>`;
});
...
var Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { index: index2 = "num" } = $$props;
  let { content = "title" } = $$props;
  let { color = "blue-600" } = $$props;
  ...
  return `<button${add_attribute("class", "grid grid-cols-1 place-self-center md:grid-cols-[1fr,4fr] w-max md:w-[281px] lg:w-[350px] h-full md:h-10 lg:h-12 text-[9px] lg:text-xs md:border font-spart text-white transition-all trakcing-[1.93px] md:tracking-[2.25px] font-normal md:font-bold focus:outline-[none] " + (active ? `border-b-4 md:bg-${color} border-${color}` : "border-grey-600 hover:bg-grey-600"), 0)}><p class="${"hidden md:block opacity-50 place-self-center"}">${escape2(index2)}</p>
    <p class="${"self-center justify-self-start uppercase"}">${escape2(content)}</p></button>`;
});
var Information = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { planet = "planet" } = $$props;
  let { content = "content" } = $$props;
  let { source = "source" } = $$props;
  ...
  return `<div class="${"\r\n    justify-self-center\r\n    md:justify-self-end\r\n    md:self-end\r\n    col-start-1\r\n    lg:col-start-2 \r\n    col-end-3\r\n    md:col-end-2\r\n    lg:col-end-3\r\n    row-start-3\r\n    md:row-start-2 \r\n    lg:row-start-1\r\n    row-end-4\r\n    md:row-end-2 \r\n    text-center md:text-left\r\n"}"><h1 class="${"font-ant text-[40px] md:text-5xl lg:text-[80px] font-medium uppercase mb-4 md:mb-3 lg:mb-[24px]"}">${escape2(planet)}</h1>
    <p class="${"text-xs lg:text-sm leading-[25px] w-[350px] h-[150px] mb-1 lg:mb-3"}">${escape2(content)}</p>
    <p class="${"inline leading-[25px] text-sm opacity-50 mb-8 md:mb-0"}">Source: 
        <a class="${"font-bold underline"}"${add_attribute("href", source, 0)}>Wikipedia</a></p>
    <img class="${"inline w-3 h-3"}" src="${"/assets/icon-source.svg"}" alt="${""}"></div>`;
});
var InfoCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var U5Bplanetu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let primeColor;
  let stageTypes;
  let images;
...
<main class="${"grid w-full h-full text-white font-spart"}"><div class="${"\r\n        grid\r\n        place-self-center\r\n        w-full\r\n        md:w-max\r\n        md:max-w-[1100px]\r\n        min-h-full\r\n        md:min-h-[auto]\r\n        lg:min-h-[75%]\r\n        grid-cols-[1fr,1fr]\r\n        lg:grid-cols-[3fr,2fr]\r\n        lg:gap-[20px]\r\n    "}"><div class="${"\r\n            grid\r\n            relative\r\n            col-start-1 col-end-3\r\n            row-start-2 row-end-3\r\n            md:row-start-1 md:row-end-2 \r\n            lg:col-start-1 lg:col-end-2 \r\n            lg:row-start-1 lg:row-end-3\r\n            min-w-full\r\n            h-[300px]\r\n            md:h-[500px]\r\n            place-content-center\r\n        "}"><img${add_attribute("src", images[stage], 0)} class="${"place-self-center transition-transform transform scale-[calc(224/582)] md:scale-[calc(369/582)] lg:scale-100"}" alt="${""}">
        ...
        ${validate_component(Information, "Information").$$render($$result, {
    planet,
    content: stageTypes[stage].content,
    source: stageTypes[stage].source
  }, {}, {})}
    ...
    color: primeColor,
    index: "02",
    content: isMD ? "internal structure" : "structure"
  }, {}, {})}
            ${validate_component(Button, "Button").$$render($$result, {
    active: stage == 2,
    color: primeColor,
